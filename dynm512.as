...
;	IMPORTANT NOTE
;
;	It is wise to keep a "safe" 200H zone between the top of C library's BSS and the current BSS at 7880H
;	Now, the top of C sources BSS is 7608H !!! 
;	Any code added to the C sources will "raise" the BSS, risking to hit 768x, leading to possible failure ...
;	This happens because some HiTech C library code uses BSS space beyond its allocated area...
;	and I discovered by chance that this "dangerous" zone is around 200H
;	So, keep a "safe" 200H distance between the top of C library's BSS and your code or data or buffers !!!	  
;
